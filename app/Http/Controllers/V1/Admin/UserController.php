...
class UserController extends Controller
{
    ...
    public function update(UserUpdate $request)
    {
        ...
        if (User::where('email', $params['email'])->first() && $user->email !== $params['email']) {
            abort(500, 'Email already in use');
        }
    ...
    public function dumpCSV(Request $request)
    {
        ...
        $data = "Email,Balance,Commission,Total Traffic,Device Limit,Remaining Traffic,Plan Expiry,Subscription Plan,Subscribe URL\r\n";
        foreach($res as $user) {
    ...
    public function generate(UserGenerate $request)
    {
        if ($request->input('email_prefix')) {
            ...
            if (User::where('email', $user['email'])->first()) {
                abort(500, 'Email already exists in system');
            }
    ...
    private function multiGenerate(Request $request)
    {
        ...
        DB::commit();
        $data = "Account,Password,Expiry Time,UUID,Created At,Subscribe URL\r\n";
    ...
    public function allDel(Request $request)
    {
        ...
        try {
            ...
            DB::rollBack();
            abort(500, 'Batch delete user information failed');
        }  
